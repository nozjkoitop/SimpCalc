...
public class MainWindowController {
    ...
    @FXML private ImageView closeBttn, minimizeBttn;
    ...
    public void init(Stage stage) {
        ...
        closeBttn.setOnMouseClicked(mouseEvent -> stage.close());
        minimizeBttn.setOnMouseClicked(mouseEvent -> stage.setIconified(true));
    }
